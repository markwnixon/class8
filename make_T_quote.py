...
# All dates must begin in datetime format and will be converted to strings as required
    ...
    if type == 'T':
        line1 = ['Quote #', 'Booking #', 'Est Start',
                 'Est Finish', 'Bill of Lading', 'Container Type']
    ...
    if type == 'T':
        ...
        try:
            line3 = [odata.Order, odata.Booking, time1, time2, odata.BOL, odata.Type]
        except:
...
# ___________________________________________________________
    ...
    c.drawCentredString(avg(q2, rtm), m7+12, 'International wires add $39.00')
    ...
    c.drawString(ltm+tb,m7+tb,'Signature                                                                       Date')
