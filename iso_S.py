...
from models import Vehicles, Storage, Invoices, JO, Income, Orders, Bills, Accounts, Bookings, OverSeas, Autos, People, Interchange, Drivers, ChalkBoard, Services
...
# ____________________________________________________________________________________________________________________B.NewJob.Storage
        if newjob is not None:
            ...
            fdata = myoslist(f'static/{scac}/data/vunknown')
            modlink=4
            leftsize=8
            leftscreen=0
        ...
        if thisjob is not None:
            ...
            if filesel != '1':
                ...
                docref=f'static/{scac}/data/vorders/'+filesel
...
# ____________________________________________________________________________________________________________________B.STORAGEnotPost
        ...
        err=['All is well', ' ', ' ', ' ',  ' ']
        bm, cm = timedata(odata)
    docref=docref.replace('static/vinvoice',f'static/{scac}/data/vinvoice')
